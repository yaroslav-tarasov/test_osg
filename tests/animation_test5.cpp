...
osg::MatrixTransform* setupAnimtkNode(osg::Geode* staticGeode) 
{
    ...
    v[0] = osg::Vec3(  0,   0,   0);
    v[1] = osg::Vec3(200, 400, 600);
    v[2] = osg::Vec3(400, 600, 200);
    v[3] = osg::Vec3(600, 200, 400);
    v[4] = osg::Vec3( 0,  0,  0);
    ...
    keys->push_back(osgAnimation::Vec3CubicBezierKeyframe(20, osgAnimation::Vec3CubicBezier(
        v[1],
        v[1] + (v[1] - v[0]),
        v[2] - (v[2] - v[1])
        )));

    keys->push_back(osgAnimation::Vec3CubicBezierKeyframe(40, osgAnimation::Vec3CubicBezier(
        v[2],
        v[2] + (v[2] - v[1]),
        v[3] - (v[3] - v[2])
        )));

    keys->push_back(osgAnimation::Vec3CubicBezierKeyframe(60, osgAnimation::Vec3CubicBezier(
        v[3],
        v[3] + (v[3] - v[2]),
        v[4] - (v[4] - v[3])
        )));

    keys->push_back(osgAnimation::Vec3CubicBezierKeyframe(80, osgAnimation::Vec3CubicBezier(
        v[4],
        v[4] + (v[4] - v[3]),
        v[0] - (v[0] - v[4])
        )));
    ...
    geode->addDrawable(new osg::ShapeDrawable(new osg::Sphere(osg::Vec3(0.0f, 0.0f, 0.0f), 20)));
