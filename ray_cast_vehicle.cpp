...
namespace ray_cast_vehicle
{
    ...
    void impl::add_wheel( double /*mass*/, double /*width*/, double radius, cg::point_3 const& offset, cg::cpr const & /*orien*/, bool /*has_damper*/ )
    {
        ...
        btWheelInfo& info = raycast_veh_->addWheel(to_bullet_vector3(connection_point),btVector3(0,0,-1),btVector3(1,0,0),0.f/*1.1f*/,btScalar(radius),tuning_,isFrontWheel);
