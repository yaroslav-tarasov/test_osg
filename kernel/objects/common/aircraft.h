...
inline std::string get_model(std::string const& kind)
{
    ...
    if (kind == "A321")
        ...
        return "b_767_300";
    else if (kind == "Mi8" || kind == "МИ-8")
        return "mi_8";
    else if (kind == "C525")
        return "cessna_525";
    else if (kind == "AN26" || kind == "АН-26")
        return "an_26";
    else if (kind == "SB20")
        return "sb20"; 
    else if (kind == "KA27" || kind == "КА-27")
        return "ka27";
    else if (kind == "KA50"|| kind == "КА-50") 
        return "ka_50";
    else if (kind == "KA52" || kind == "КА-52" )
        return "ka_52";
    else if (kind == "L39" || kind == "Л-39")
        return "l_39";
	else if (kind == "AN140" || kind == "АН-140")
		return "an_140";
    else if (kind == "SU25" || kind == "СУ-25")
        return "su_25tm";
    else if (kind == "MIG29" || kind == "МИГ-29")
        return "mig_29";
	else if (kind == "MIG29K" || kind == "МИГ-29К")
		return "mig_29k";
    else
        return "checker";
}
