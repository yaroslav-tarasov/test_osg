...
{
    struct forsage_effect_support_traits : effect_support_traits
    {
    ...
    struct forsage_support : effect_support< forsage_support, FireSfxNode, forsage_effect_support_traits >
    {
