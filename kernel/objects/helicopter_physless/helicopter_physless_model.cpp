...
#include "helicopter_physless_model.h"
#include "helicopter_physless_common.h"

#include "sync_fsm/sync_heli_phys_state.h"
#include "sync_fsm/sync_heli_none_state.h"
#include "sync_fsm/sync_heli_fms_state.h"
//
...
AUTO_REG_NAME(helicopter_physless_model, model::create);
